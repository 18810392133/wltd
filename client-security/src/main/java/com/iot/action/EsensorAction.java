...
public class EsensorAction {
    ...
    public Map<Object, Object> selectByPage(Integer page, Integer rows, String sort, String order, String filterRules){
        return esensorService.selectByPage(page, rows, sort, order, filterRules);
    }
    ...
    public Map<Object, Object> selectVByPage(Integer page, Integer rows, String sort, String order, String filterRules){
        return esensorService.selectVByPage(page, rows, sort, order, filterRules);
    }
    ...
    public Map<Object, Object> selectSubByPage(Integer projectid, Integer page, Integer rows, String sort, String order, String filterRules){
        return esensorService.selectSubByPage(projectid, page, rows, sort, order, filterRules);
    }
    ...
    public Map<Object, Object> selectSubVByPage(Integer projectid, Integer page, Integer rows, String sort, String order, String filterRules){
        return esensorService.selectSubVByPage(projectid, page, rows, sort, order, filterRules);
    }
    ...
    public Map<Object, Object> insert(String item, Integer projectid, String protocol, Integer timer, String note) {
        Map<Object, Object> map = new HashMap<Object, Object>();
        if(isValidate(item, projectid, 0)){
            Esensorv sensor = esensorService.insert(item, projectid, protocol, timer, note);
            if(sensor != null)
    ...
    public Map<Object, Object> update(Integer id, String item, Integer projectid, String protocol, Integer timer, String note) {
        Map<Object, Object> map = new HashMap<Object, Object>();
        if(isValidate(item, projectid, id)){
            Esensorv sensor = esensorService.update(id, item, projectid, protocol, timer, note);
            if(sensor != null)
                map = new BeanMap(sensor);
        }else{
            map.put("isError", true);
    ...
    public JSONArray list(Integer projectid){
        ...
        List<Esensor> list = esensorService.selectBySql("projectid=" + projectid);
    ...
    public boolean isValidate(String item, Integer projectid, Integer id){
        List<Esensor> list = esensorService.selectBySql("item='" + item + "' and projectid=" + projectid + " and id!=" + id);
        if(list.size() > 0)
            return false;
        else
            return true;
